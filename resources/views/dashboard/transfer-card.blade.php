@php
    if (request()->routeIs('user.transactions') ) {// request()->routeIs('transactions')) {
...
<div class="col-xl-12 col-lg-12 col-md-12 col-12 {{ $showFirstCard??"" }}">
    <div class="site-card">
        <div class="site-card-body transfer-top-btns">
            ...
            <a href="{{ route('user.transfer-log') }}" class="site-btn-sm"><i data-lucide="alert-circle"></i> Transfer
                history</a>
        </div>
    </div>
</div>
